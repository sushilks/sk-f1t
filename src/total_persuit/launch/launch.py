...
def generate_launch_description():
    ...
    total_persuit_parameters_file = os.path.join(
        get_package_share_directory('total_persuit'),
        'config', 'total_persuit.yaml'
    )
    ...
    total_persuit = Node(
            package='total_persuit', executable='total_persuit',
            parameters=[launch.substitutions.LaunchConfiguration('total_persuit_config')])
    # finalize
    ld = LaunchDescription([launch.actions.DeclareLaunchArgument('total_persuit_config', default_value=total_persuit_parameters_file)
                            ])
